...
if __name__ == "__main__":
    ...
    while carro1.odometro < 600 and carro2.odometro < 600:
        try:
            ...
            if numero_carro == 1: operar_carro (carro1)
            elif numero_carro == 2: operar_carro (carro2)
    ...
    if carro1.odometro >= 600: print ('O carro 1 venceu a corrida')
    else: print ('O carro 2 venceu a corrida')
